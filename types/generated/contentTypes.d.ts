...
export interface ApiHomePageHomePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero_cta_primary_active: Schema.Attribute.Boolean;
    hero_cta_primary_link: Schema.Attribute.String;
    hero_cta_primary_txt: Schema.Attribute.String;
    hero_cta_secondary_active: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    hero_cta_secondary_link: Schema.Attribute.String;
    hero_cta_secondary_txt: Schema.Attribute.String;
    hero_description: Schema.Attribute.Text;
    hero_micro_label: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'FRONTLINE INSIGHTS'>;
    ...
    > &
      Schema.Attribute.Private;
    partner_brand_txt: Schema.Attribute.String;
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        'sections.magazine-release',
        'sections.elite-archives',
        'sections.women-visionaries',
        'sections.hall-of-fame',
        'sections.trending-insights',
        'sections.innovation-technology',
        'sections.visionary-voices',
        'sections.showcase',
        'sections.editorial-highlight',
      ]
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomeSectionHomeSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    content: Schema.Attribute.Component<'sections.section-content', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    media_items: Schema.Attribute.Component<'sections.section-media', true>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'internal_name'>;
...
export interface ApiMagazineMagazine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_highlight: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_brand_name: Schema.Attribute.String;
    footer_brand_name_left: Schema.Attribute.String;
    footer_brand_name_right: Schema.Attribute.String;
    footer_micro_label: Schema.Attribute.String;
    footer_quick_links: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-quick-link.footer-quick-link'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    navbar_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::nav-item.nav-item'
    >;
    publishedAt: Schema.Attribute.DateTime;
    show_contact_button: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
